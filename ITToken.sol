...
contract ITToken is Context, IBEP20, Ownable {
    ...
    function mint(uint256 amount) public onlyOwner returns (bool) {
        require(_mintable == true, "this token is not mintable");
        _mint(_msgSender(), amount);
        return true;
    }

    /**
     * @dev change to stop further minting
     */
